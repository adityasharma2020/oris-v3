import styles from "./CummulativeRySkewPage.module.scss";
...
export default function CummulativeRySkewPage() {
  ...
  const getImage = async () => {
    ...
    link.download = "CummulativeRySkewPage_CSV_DATA.png";
    link.href = dataUrl;
    link.click();
  };
  ...
  const handleSubmit = () => {
    ...
    for (let i = startIndex; i < endIndex; i += increment) {
      ...
      tempValue = (numberOfM - numberOfK) / (numberOfK + numberOfM)+tempValue
  ...
  const csvReport = {
    ...
    filename: "CummulativeRYSkewPage_CSV_DATA.csv",
  };
  ...
  return currentFile ? (
    <div className={styles.brushChartContainer}>
      ...
      {!modalVisible ? (
        <>
          <Card
            title={"CummulativeRYSkewPage   - " + currentFileName}
